...
CREATE TABLE formula (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    price_smaller_or_equal_to_10m3 DOUBLE,
    price_from_10m3_to_20m3 DOUBLE,
    price_from_20m3_to_30m3 DOUBLE,
    price_greater_or_equal_30m3 DOUBLE,
    vat_tax_per DOUBLE,
    bvmt_tax DOUBLE,
    base_id BIGINT,
    actived boolean,
...
(1,8500,9900,16000,27000,5,10,1,1),
(2,5973,9900,16000,27000,5,10,1,2),
(3,13500,13500,13500,13500,5,10,1,3),
(4,13500,13500,13500,13500,5,10,1,4),
(5,16000,16000,16000,16000,5,10,1,5),
(6,29000,29000,29000,29000,5,10,1,6);
